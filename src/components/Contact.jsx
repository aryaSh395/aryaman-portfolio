      ...
      <div className="section-inner">
        ...
        <div className="contact-card glass-card reveal delay-1">
          ...
          <div className="contact-chips">
            <a href="mailto:aryamansharma.it24@gmail.com" className="contact-chip"><EmailIcon /> aryamansharma.it24@gmail.com</a>
            <a href="tel:+917891039292" className="contact-chip"><PhoneIcon /> +91 7891039292</a>
            <span className="contact-chip"><LocationIcon /> Jaipur, India</span>
          </div>
        </div>
        ...
        <div className="contact-footer">
          <div className="footer-socials">
            {[
              ...
              <a key={href} href={href} target="_blank" rel="noreferrer" className="footer-social" aria-label={label}>{icon}</a>
            ))}
          </div>
          <div className="footer-copy">© 2026 Aryaman Sharma — built with <span className="accent">React</span> + <span className="accent">Vite</span></div>
        </div>
      </div>
    </section>
  );
